...
INSERT IGNORE INTO ai_models (id, name, provider, model_id, credits_per_chat, min_tier, display_order) VALUES
  ...
  ('model-qwen-flash-char', '通義 Flash キャラ', 'qianwen', 'qwen-flash-character', 2, 'free', 0),
  -- 高级会员：角色还原更强
  ('model-qwen-plus-char',  '通義 Plus キャラ',  'qianwen', 'qwen-plus-character',  8, 'basic', 3),
  -- 日语特化模型（admin / 自测用）
  ('model-qwen-plus-char-ja','通義 Plus キャラ JA','qianwen','qwen-plus-character-ja',20,'admin', 4);
